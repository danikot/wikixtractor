	   ...
	   */
	    ...
	    //WikiExtractor reset
					...
					case "reset":
						...
						try {FileUtils.deleteDirectory(moribund);} catch (IOException e) {}
		...
		//WikiExtractor categorylinks
					...
					//    	  try{
					    		  ...
					    		  //System.out.println(ArticlesSkimmedCAT + "- currently doing " + node.getProperties("title"));
					    		  ArticlesSkimmedCAT++;
					      			
					      			if((ArticlesSkimmedCAT%1000)==0){tx.close();tx=graphDb.beginTx();System.out.println("Deinde millecentum!");}
